...
const SideBar = (): JSX.Element => {
  ...
  return (
    <div className="bg-primary-500">
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-primary-400 dark:bg-gray-800">
          <a
            href="#"
          ...
          <ul className="space-y-2 font-medium">
            <li>
              ...
              >
                ...
                <span className="ms-3 text-white group-hover:text-gray-900">Homepage</span>
              </a>
            </li>
            <li>
              <a
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-white group-hover:text-gray-900">Discover</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ms-3 whitespace-nowrap text-white group-hover:text-gray-900">Sign Out</span>
              </a>
            </li>
          </ul>
        </div>
